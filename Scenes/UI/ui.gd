...
## NOTE in the Inspector, the Node/Process/Mode is set to Always
## So that the UI will continue to function when the game is paused.
...
func set_tower_preview(tower_type, mouse_position):
	print_rich("[font_size=15][color=peru]UI/ set_tower_preview; tower_type = ", tower_type, "; mouse_position = ", mouse_position)
	...
	print_rich("[font_size=15][color=peru]UIset tower preview/1. drag tower = ", drag_tower)
	...
	print_rich("[font_size=15][color=peru]UI/set tower preview/2. drag tower = ", drag_tower, "; drag tower ame = ", drag_tower.name)
	...
	print_rich("[font_size=15][color=peru]UI/set_tower_preview/; drag_tower = ", drag_tower, "; range_texture = ", range_texture, "; mouse_position = ", mouse_position)
	...
	print_rich("[font_size=15][color=peru]UI/set tower preview/control = ", control)
	
	
##continuously called by 'update_tower_preview()' in world.gd if we are in build mode.
...
func update_tower_preview(new_position : Vector2, color : String):
	if print_flag:
		print_rich("[font_size=15][color=peru]UI/update tower preview")
		print_flag = false
...
func _on_gun_mouse_entered() -> void:
	print_rich("[font_size=15][color=peru]UI/SIGNAL_on_gun_mouse_entered()")
...
func _on_gun_mouse_exited() -> void:
	print_rich("[font_size=15][color=peru]UI/SIGNAL_on_gun_mouse_exited()")

	Popups.HideItemPopup()


func _on_missile_mouse_entered() -> void:
	print_rich("[font_size=15][color=peru]UI/SIGNAL_on_missile_mouse_entered()")
...
func _on_missile_mouse_exited() -> void:
	print_rich("[font_size=15][color=peru]UI/SIGNAL_on_missile_mouse_exited()")
	Popups.HideItemPopup()
	
	
func wall_tower_upgrade() -> void:
		print_rich("[font_size=15][color=peru]UI/wall_tower_upgrade()")
